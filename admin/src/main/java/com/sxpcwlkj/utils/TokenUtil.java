...
public class TokenUtil {
    ...
    public static void main(String[] res) {
        ...
        String token ="eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiIyIiwiaWF0IjoxNjExMzAxNjcxLCJjb2RlIjp7Im9iamVjdENvZGUiOiJEUFdGSUVYdXBvRVNzQlZxZWNEalU3RnBHMW9KTzE5MiIsIm9iamVjdElkIjoyfSwic3ViIjoi5ZOB5Yib572R57ucIiwiZXhwIjoyMjEwODMxMTA4fQ.sMf9cKYdOwiGBUf_Ofgf18aNb8QorZ9t_88PfeFEl8U";

        Map<String, Object> data = TokenUtil.getpareJwt(token);
