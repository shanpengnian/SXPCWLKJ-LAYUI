...
public class DateUtil {
    public static void main(String[] args) {
        try {
            ...
            Date dq=getFirstDayOfWeek(new Date());

            getAddNumDay(dq, 1);

            System.out.println(getDateToStr(getFirstDayOfWeek(new Date()),DateUtil.DATE_FORMAT_YYYY_MM_DD));

            Date  ttt= getAddDate(dq,0,0,12,0,0,0,0);

            System.out.println(getDateToStr(getFirstDayOfWeek(ttt),DateUtil.DATE_FORMAT_YYYY_MM_DD));
